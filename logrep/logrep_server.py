...
class SearchArgs:
    ...
    def from_settings_and_args_with_validation(cls, settings: Settings, discard_before: str | None, before_context: int | None, pattern: str | None, except_pattern: str | None, after_context: int | None, discard_after: str | None, files_with_matches: bool):
        ...
        if _discard_before:
            if is_probably_complex_pattern(_discard_before):
                try:
        ...
        if _pattern:
            if is_probably_complex_pattern(_pattern):
                try:
        ...
        if _except_pattern:
            if is_probably_complex_pattern(_except_pattern):
                try:
        ...
        if _discard_after:
            if is_probably_complex_pattern(_discard_after):
                try:
